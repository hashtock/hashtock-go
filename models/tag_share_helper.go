...
func GetProfileShares(req *http.Request, profile *Profile) (shares []core.TagShare, err error) {
...
func GetProfileShareByTagName(req *http.Request, profile *Profile, hashTagName string) (tagShare *core.TagShare, err error) {
...
func getOrCreateTagShare(req *http.Request, profile *Profile, hashTagName string) (tagShare *core.TagShare, err error) {
	col := storage.Collection(TagShareCollectionName)
	defer col.Database.Session.Close()
